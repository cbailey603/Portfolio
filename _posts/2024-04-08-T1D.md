...
layout: post
post-image: "https://cbailey603.github.io/Portfolio/assets/images/T1D_files/honeymoon_phase.png"
...
<img src="https://cbailey603.github.io/Portfolio/assets/images/T1D_files/effective_carbs.png"
    class="center">
<p>
</p>
...
<img src="https://cbailey603.github.io/Portfolio/assets/images/T1D_files/effective_bolus.png"
    class="center">
<p>
</p>
...
<img src="https://cbailey603.github.io/Portfolio/assets/images/T1D_files/BGdist.png"
    class="center">

<p>
Firstly, the shape of the distribution indicates that it is not normally distributed; it is slightly skewed to the right. This makes sense, considering the differences in physical symptoms between a low BG (<70mg/dL) and a high BG (>180mg/dL). Low blood glucose is uncomfortable and dangerous. Symptoms include feeling lightheaded, dizzy, sweaty, and hungry; worse symptoms can arise if the low becomes drastic. Conversely, high blood glucose does not manifest physical symptoms unless levels are considerably high and/or long-term. Therefore, diabetics experiencing low blood sugar can and will react promptly, usually by consuming glucose. Returning to the BG distribution with that in mind, we can see that high blood glucose is more common than low blood glucose and persists for longer, resulting in a right-skewed distribution. Lastly, we can see that I spend most of my time in the normal blood glucose range, which is great! This can be quantified as time-in-range and is represented as a percentage, which is calculated below:
</p>
...
<img src="https://cbailey603.github.io/Portfolio/assets/images/T1D_files/honeymoon_phase.png"
    class="center">
...
<img src="https://cbailey603.github.io/Portfolio/assets/images/T1D_files/dailycarbs.png"
    class="center">
<p>
</p>
...
<img src="https://cbailey603.github.io/Portfolio/assets/images/T1D_files/BG_during_exercise.png"
    class="center">
<p>
</p>
...
<img src="https://cbailey603.github.io/Portfolio/assets/images/T1D_files/ONE_DAY/NNETAR_forecast.png"
    class="center">
<p>
</p>
...
[All data and files can be found on my Github](https://github.com/cbailey603/T1D)
